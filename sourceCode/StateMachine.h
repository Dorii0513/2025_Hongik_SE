...
private:
    ...
    void displayInputValue();     // 입력된 값이 출력되었습니다. 
    void overwriteOperator();     // 입력된 연산자가 이전 연산자를 대체했습니다. 
    void eraseAllDisplayResult(); // 연산결과가 출력되었습니다. 
    void eraseAllDisplayDigit();  // 이전 연산결과를 지우고 입력된 값이 출력되었습니다. 
